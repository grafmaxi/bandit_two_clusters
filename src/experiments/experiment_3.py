...
def simulation_iteration_3(seed: int) -> Tuple[np.ndarray,
                                               np.ndarray,
                                               np.ndarray,
                                               np.ndarray,
                                               np.ndarray,
    ...
    for theta_idx in range(theta_size):
        ...
        cr_errors[theta_idx] = int(
            true_clusters[0] == true_clusters[cr_arms[0]])
        ...
        for budget_idx in range(budget_steps):
            ...
            km_errors[theta_idx, budget_idx] = 1 - \
